...
//
$query = "UPDATE `qp_table` SET `Status`='$varStatus',`Email`='$varEmail$varStatus' WHERE `refID`='$varRefID'";
...
$subjectName = 'Quarantine Pass Decline';
$yourName = $varFname;
$refID = $varRefID;
...
Hi! '.$yourName.'<br/>
                 <br/>
	Sorry to inform you that your request for Quarantine pass was declined. Please provide a valid response on the form and re-apply again.  http://bucandalateamapp.ddns.net/
<br/>
<br/>
...
//end of email sender-------------------------------
	header("location: Admin-QP.php?Decline=Succes");			

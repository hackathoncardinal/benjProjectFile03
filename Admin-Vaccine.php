...
$txtSearch = $_POST['txtRequest_search'];
	...
	$queryRequest = mysqli_query($dbc,"SELECT * From vaccine_table where(status='$r1')");
	$queryUnclaimed = mysqli_query($dbc,"SELECT * From vaccine_table where(status='$r2')");
	$queryClaimed = mysqli_query($dbc,"SELECT * From vaccine_table where(status='$r3')");
		echo "<script>alert('Textbox Or Filter Column was Empty');</script>";
	}else{
	$queryRequest = mysqli_query($dbc,"SELECT * FROM `vaccine_table` WHERE Status='$r1' AND $col1 LIKE '%$txtSearch%'");
	//mysqli_num_rows($queryRequest)
	if(mysqli_num_rows($queryRequest) > 0){
		//echo "<script>alert('data Found');</script>";
	}else{ $queryRequest = mysqli_query($dbc,"SELECT * From vaccine_table where(status='$r1')"); 
...
$txtSearch = $_POST['txtRequest_search2'];
	...
	$queryUnclaimed = mysqli_query($dbc,"SELECT * FROM `vaccine_table` WHERE Status='$r2' AND $col1 LIKE '%$txtSearch%'");
	//mysqli_num_rows($queryRequest)
	if(mysqli_num_rows($queryUnclaimed) > 0){
		//echo "<script>alert('data Found');</script>";
	}else{ $queryUnclaimed = mysqli_query($dbc,"SELECT * From vaccine_table where(status='$r2')");
		 	echo "<script>alert('data not Found');</script>";
		 }
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                       <li><a  href="Admin-Dashboard.php">Dashboard</a></li>
                        ...
                        <li><a class="active" href="Admin-Vaccine.php">Vaccine DB</a></li>
...
<div class="container">
	<div style="text-align: -webkit-center;">
		<form method="POST" action="Admin-Vaccine.php">
...
//                alert(msg);
           ...
           Passvalue1(therow.cells[0].innerHTML,therow.cells[1].innerHTML,therow.cells[2].innerHTML,therow.cells[3].innerHTML,therow.cells[4].innerHTML,therow.cells[5].innerHTML,therow.cells[6].innerHTML,therow.cells[7].innerHTML,therow.cells[8].innerHTML,therow.cells[9].innerHTML,therow.cells[10].innerHTML,therow.cells[11].innerHTML,therow.cells[12].innerHTML,therow.cells[13].innerHTML);
            window.location = "Admin-vaccine-Dataseleted.php";
...
//                alert(msg);
           ...
           Passvalue1(therow.cells[0].innerHTML,therow.cells[1].innerHTML,therow.cells[2].innerHTML,therow.cells[3].innerHTML,therow.cells[4].innerHTML,therow.cells[5].innerHTML,therow.cells[6].innerHTML,therow.cells[7].innerHTML,therow.cells[8].innerHTML,therow.cells[9].innerHTML,therow.cells[10].innerHTML,therow.cells[11].innerHTML,therow.cells[12].innerHTML,therow.cells[13].innerHTML);
            window.location = "Admin-Vaccine-Dataseleted-Unclaimed.php";
...
function Passvalue1(refID,Fname,Lname,Mname,Email1,Register_voter,Address,BOD,Contact,Gender,Age,Status1,Request_date,img_type){
      // var Firstname = data1 ;

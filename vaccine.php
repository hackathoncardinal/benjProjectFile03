...
<head>
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Vaccine Application</title>  
...
<body onload="initClock(),loading();">
 ...
 <header class="header header_style_01">
        <nav class="megamenu navbar navbar-default">
            ...
            <div class="container-fluid">
                <div class="navbar-header">
					<a class="navbar-brand" href="#"><img src="images/logos/VaccineLogo1.png" style="width: 100%;" alt="image"></a>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                  ...
                  <li><a  href="index.html">Home</a></li>
                        ...
                        <li><a  class="active" href="vaccine.php">Vaccine</a></li>
  ...
  <form method="POST" action="vaccine_insertData.php" enctype="multipart/form-data" onsubmit="return BlankData()">          
<div class="container-fluid"> 

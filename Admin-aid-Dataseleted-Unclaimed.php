...
<head>
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Data Selected Unclaim</title>  
...
<body>
    ...
    <!-- END LOADER -->
<div id="data1">
<form method="POST" action="Admin-Aid-Claim.php" enctype="multipart/form-data" onsubmit="return Claim()" > 
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box" style="color: #000">
						...
						<input hidden id="txtypeofReq" name="txtypeofReq">
						...
						Type of Request : <span id="typeofReq"></span><br> 
<!--
...
<script>
 //displaying the value from local storage to another page by their respective Ids
	...
	document.getElementById("typeofReq").innerHTML = localStorage.getItem("LS_typeofReq",typeofReq);
...
function Claim(){
	//txtypeofReq
	document.getElementById("txtypeofReq").value = localStorage.getItem("LS_typeofReq",typeofReq);
	...
	if(confirm("Are you sure you want to Claim this record?\n")){
		if(document.getElementById("txtPersonClaim").value == ""  || document.getElementById("txtypeofReq").value == "" ){

...
<body>
    ...
    <!-- END LOADER -->
<div id="data1">
<form method="POST" action="Admin-aid-Approve.php" enctype="multipart/form-data" onsubmit="return Approve()" > 
...
<div class="form-horizontal" style="text-align: center;"> 
	...
	<form method="POST" action="Admin-Aid-Decline.php" enctype="multipart/form-data" onsubmit="return Decline()" > 

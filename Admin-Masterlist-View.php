...
if(isset($_POST['btnRequest_search'])){
	...
	if(empty($txtSearch) || empty($col1)){
		...
		if($txtSearch == "" and $col1 == "masterlist_table" ){
			...
			$queryRequest = mysqli_query($dbc,"SELECT * From masterlist_table where 0");
		}
	...
	else
	{
		...
		if($txtSearch == "" and $col1 == "masterlist_table" ){
			...
			$queryRequest = mysqli_query($dbc,"SELECT * FROM `masterlist_table` WHERE $col1 LIKE '%$txtSearch%'");
...
}else{ $queryRequest = mysqli_query($dbc,"SELECT * From masterlist_table where 1");  }
...
<head>
  <!-- Basic -->
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Admin Master list View Data</title>  

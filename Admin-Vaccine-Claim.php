...
//
$query = "UPDATE `vaccine_table` SET `Status`='$varStatus',`Request_Claimed_date`='$varRequest_Claimed_date' WHERE `refID`='$varRefID'";
...
Hi! '.$yourName.'<br/>
                 <br/>
This is to inform you that your Vaccine has been claimed last '.$varRequest_Claimed_date.'.
<br/>
...
//end of email sender-------------------------------
	header("location: Admin-Vaccine.php?Claim=Succes");			

...
$query1 = "SELECT * FROM `vaccine_table` WHERE (SetClaim='$varSetDateClaim' AND sessionType='$varSession')";
...
//
$query = "UPDATE `vaccine_table` SET `Status`='$varStatus',`Request_Approved_date`='$varRequest_Approved_date',`SetClaim`='$varSetDateClaim',`sessionType`='$varSession' WHERE `refID`='$varRefID'";
...
Hi! '.$yourName.'<br/>
                 <br/>
Your request for Vaccine  form has been accepted. 
...
//end of email sender-------------------------------
	header("location: Admin-Vaccine.php?Approve=Succes");			
	...
	exit();
			...
			header("location: Admin-Vaccine.php?Approve=Error");
	}

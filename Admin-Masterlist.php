...
<head>
  <!-- Basic -->
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Admin Master list Edit Data</title>  
...
<form method="POST" action="Admin-Masterlist-AddDataFN.php">
				...
				<?php  
						...
						if(strpos($FullUrl,"insert=empty")){
							...
							//echo "<p class='error1'> data Add  successfully ! </p> ";
							echo "<script>alert('Data Add successfully ! !');   window.location = 'Admin-Masterlist-View.php'; </script>";
						}

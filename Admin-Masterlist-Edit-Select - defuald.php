...
<form method="POST" action="Admin-Masterlist-AddDataFN.php">
				...
				<?php  
						...
						if(strpos($FullUrl,"insert=empty")){
							...
							//echo "<p class='error1'>  data successfully saved! </p> ";
							echo "<script>alert('Data Update successfully ! !');   window.location = 'Admin-Masterlist-View.php'; </script>";
						//	header("location: Admin-Masterlist-View.php");  
						}
	...
	<div class="form-horizontal"> 
				...
				<div class="form-group"> 
					...
					<input type="text" size="60"
						...
						id="IDnumber" name="txtID" placeholder="Please Enter existing ID number to Update " required /> 
					</div> 
				</div>
				...
				<div class="form-group"> 
					...
					<input type="text" size="60"
						maxlength="60" class="form-control"
						id="Firstname" name="txtFname" placeholder="Enter content" required /> 
					</div> 
				</div>
				<!-- asdasdasdasd-->
				<div class="form-group"> 
					...
					<input type="text" size="60"
						maxlength="60" class="form-control"
						id="Lastname" name="txtLname" placeholder="Enter content"  required /> 
					</div> 
				</div> 
				...
				<div class="form-group"> 
					...
					<input type="text" size="60"
						maxlength="60" class="form-control"
						id="Middle" name="txtMname" placeholder="Enter content" required /> 
					</div> 
				</div> 
			...
			<div class="form-group"> 
				...
				<div class="form-group"> 
					...
					<input type="email" size="60"
						maxlength="60" class="form-control"
						id="EmailAddress1" name="txtEmail" placeholder="Enter content" required /> 
					</div> 
				</div> 
				...
				<div class="form-group"> 
					...
					<input type="text" size="100"
						...
						id="Address" name="txtAddress" placeholder="Enter content" required /> 

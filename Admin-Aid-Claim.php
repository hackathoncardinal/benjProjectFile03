...
//
$query = "UPDATE `aid_table` SET `Status`='$varStatus',`Request_Claimed_date`='$varRequest_Claimed_date' WHERE `refID`='$varRefID'";
...
Hi! '.$yourName.'<br/>
                 <br/>
This is to inform you that your Aid has been claimed last '.$varRequest_Claimed_date.'.
<br/>
...
//end of email sender-------------------------------
	header("location: Admin-Aid.php?Claim=Succes");			
